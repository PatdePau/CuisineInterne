...
lienMenus.setAttribute('class', "lien");
// et lui donne un peu de contenu 
...
lienOr.setAttribute('href', "./livredor.php");
lienOr.setAttribute('class', "lien");
// et lui donne un peu de contenu 
...
lienReserv.setAttribute('href', "./reservation.php");
lienReserv.setAttribute('class', "lien");
// et lui donne un peu de contenu 
...
function afficheMenu(){
    menu.classList.toggle("apparait");
    console.log(menu);
}